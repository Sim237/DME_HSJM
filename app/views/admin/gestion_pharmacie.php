...
?>
        ...
        <div class="admin-topbar">
            ...
            <div class="adm-topbar-actions">
                ...
                <button class="adm-topbtn adm-topbtn-ghost" onclick="downloadTemplate()">
                    <i class="bi bi-download"></i> Modèle CSV
                </button>
                <button class="adm-topbtn adm-topbtn-ghost" onclick="document.getElementById('importZone').classList.toggle('d-none')">
                    <i class="bi bi-file-earmark-arrow-up"></i> Importer
                </button>
                <button class="adm-topbtn adm-topbtn-primary" onclick="openMedModal()">
                    <i class="bi bi-plus-circle-fill"></i> Nouveau médicament
                </button>
            </div>
        </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-6 col-md-3">
                    <div class="adm-stat" style="--adm-accent:#6366f1;">
                        <div class="adm-stat-val"><?= $totalMeds ?></div>
                        <div class="adm-stat-lbl">Références</div>
                        <i class="bi bi-capsule-pill adm-stat-ico"></i>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="adm-stat" style="--adm-accent:#22c55e;">
                        <div class="adm-stat-val"><?= $ok ?></div>
                        <div class="adm-stat-lbl">Stock OK</div>
                        <i class="bi bi-check-circle-fill adm-stat-ico"></i>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="adm-stat" style="--adm-accent:#f59e0b;">
                        <div class="adm-stat-val"><?= $critique ?></div>
                        <div class="adm-stat-lbl">Stock critique</div>
                        <i class="bi bi-exclamation-triangle-fill adm-stat-ico"></i>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="adm-stat" style="--adm-accent:#ef4444;">
                        <div class="adm-stat-val"><?= $rupture ?></div>
                        <div class="adm-stat-lbl">Ruptures</div>
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-3">
                <div class="card-body p-3">
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-3">
                            <select id="filterFamille" class="form-select form-select-sm rounded-3" onchange="filterTable()">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0" id="medTable" style="font-size:.83rem;">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr data-statut="<?= $ds ?>" data-famille="<?= htmlspecialchars($m['famille'] ?? '') ?>">
                                    <td class="ps-4">
                                    ...
                                    <td>
                                        ...
                                        <span class="badge rounded-pill bg-primary-subtle text-primary border border-primary-subtle" style="font-size:.68rem;font-weight:600;">
            ...
            <form id="formMed">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label fw-bold small">FAMILLE / CATÉGORIE</label>
                            <select name="famille" id="medFamille" class="form-select">
...
function openEditMed(m) {
    ...
    document.getElementById('medFamille').value  = m.famille || '';
...
function filterTable() {
    ...
    document.querySelectorAll('#medTable tbody tr').forEach(tr => {
        ...
        const dfam    = tr.dataset.famille || '';
        const matchQ   = !q   || text.includes(q);
        const matchSt  = !st  || ds === st;
        const matchFam = !fam || dfam === fam;
        tr.style.display = (matchQ && matchSt && matchFam) ? '' : 'none';
    });
}
