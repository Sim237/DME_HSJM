...
?>
        ...
        <div class="admin-topbar">
            ...
            <div class="d-flex gap-2">
                <button class="btn btn-outline-primary rounded-pill px-3 fw-bold" onclick="openChambreModal()">
                    <i class="bi bi-plus-square me-1"></i>Nouvelle Chambre
                </button>
                <button class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm" onclick="openLitModal()">
                    <i class="bi bi-plus-circle me-2"></i>Nouveau Lit
                </button>
            </div>
        </div>
        ...
        <div class="admin-page-content">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 p-3 text-center">
                        <div class="fs-2 fw-black text-primary"><?= count($chambres) ?></div>
                        <small class="text-muted fw-bold text-uppercase">Chambres</small>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 p-3 text-center">
                        <div class="fs-2 fw-black text-dark"><?= $totalLits ?></div>
                        <small class="text-muted fw-bold text-uppercase">Lits au total</small>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 p-3 text-center">
                        <div class="fs-2 fw-black text-danger"><?= $occupes ?></div>
                        <small class="text-muted fw-bold text-uppercase">Occupés</small>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 p-3 text-center">
                        <div class="fs-2 fw-black <?= $tauxGlobal > 80 ? 'text-danger' : ($tauxGlobal > 50 ? 'text-warning' : 'text-success') ?>"><?= $tauxGlobal ?>%</div>
                        <small class="text-muted fw-bold text-uppercase">Taux d'occupation</small>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-header bg-white border-0 py-3 px-4 d-flex justify-content-between align-items-center">
                    <h6 class="mb-0 fw-bold"><i class="bi bi-building me-2 text-primary"></i><?= htmlspecialchars($serviceName) ?></h6>
                    <?php
