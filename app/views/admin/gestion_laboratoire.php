...
?>
        ...
        <div class="admin-topbar">
            ...
            <div class="d-flex gap-2">
                <button class="btn btn-outline-secondary rounded-pill btn-sm px-3" onclick="openCatModal()">
                    <i class="bi bi-tags me-1"></i>Catégories
                </button>
                <button class="btn btn-primary rounded-pill btn-sm px-3" onclick="openExamenModal()">
            ...
            <div class="row g-3 mb-4">
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 p-3 text-center">
                        <div class="fs-2 fw-bold text-dark"><?= $totalExamens ?></div>
                        <small class="text-muted fw-bold text-uppercase">Total examens</small>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 p-3 text-center">
                        <div class="fs-2 fw-bold text-success"><?= $disponibles ?></div>
                        <small class="text-muted fw-bold text-uppercase">Disponibles</small>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 p-3 text-center">
                        <div class="fs-2 fw-bold text-danger"><?= $totalExamens - $disponibles ?></div>
                        <small class="text-muted fw-bold text-uppercase">Indisponibles</small>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 p-3 text-center">
                        <div class="fs-2 fw-bold text-primary"><?= count($categories) ?></div>
                        <small class="text-muted fw-bold text-uppercase">Catégories</small>
                    </div>
                </div>
            </div>
